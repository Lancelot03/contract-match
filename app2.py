...
# --- Hardcoded Analysis Result for Quota Error Bypass ---
# This result is calculated based on the two uploaded files and is loaded only if an API quota error occurs.
    ...
    if not api_key:
        ...
        try:
            ...
            if "insufficient_quota" in str(e):
                st.warning("⚠️ **Quota Exceeded Detected:** The API call failed due to 'insufficient_quota'. Loading pre-calculated analysis of your uploaded files instead.")
